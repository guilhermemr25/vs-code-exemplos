...
console.log("Após remover Banana:", frutas); // ["Maça", "Laranja", "Uva"]

// Exemplo 2 - remover dois itens
const numeros = [10, 20, 30, 40, 50];
numeros.splice(1, 2); // Remove 2 itens a partir do indice 1 (20 e 30)
...
frutas2.splice(2, 0, "Laranja"); // Na posição 2, remove è e adiciona "Laranja"
