 ...
 * 📌 MÉTODO: every()
 * ============================================================================================
 * Função: Verifica se TODOS os elementos cumprem rigorozamente a condição.
...
// Array de notas (valores de exemplo baseados no contexto)
const notas = [7.5, 8.2, 9.5, 6.0];
